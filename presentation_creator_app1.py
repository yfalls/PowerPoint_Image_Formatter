...
def create_widescreen_presentation_with_images(output_path, images, crop_left=0, crop_bottom=0, new_height_inches=6.0, position="Lower Right"):
    prs = Presentation()
    ...
    for image in images:
        ...
        try:
            with Image.open(image) as img:
                ...
                # Position the image based on the selected option
...
position = st.selectbox("Image Position", ["Lower Right", "Lower Left", "Lower Middle", "Center Middle"])
    ...
    if not uploaded_zip or not output_file_name:
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            if not images:
                ...
                # Run the presentation creation function with user-defined height and position
                create_widescreen_presentation_with_images(output_path, images, crop_left, crop_bottom, new_height_inches, position)
